<?php //Template Name: migrate visa Template ?>
                ...
                <div class="inner-content text-center clearfix">
                    ...
                    <div class="breadcrumb-menu wow slideInDown animated" data-wow-delay="0.3s" data-wow-duration="1500ms">
                        <ul class="clearfix">
                            ...
                            <li class="active">Migrate Visa</li>
                        </ul>    
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="visa-detail-content">
                    <div class="img-box">
                        <img src="assets/images/visa/visa-detail-1-cat-9.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <h2>Migrate Visa</h2>
                ...
                <div class="sidebar-style1">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">     
                            ...
                            <li class="active"><a href="visa-migrate.html"><i class="fa fa-angle-left" aria-hidden="true"></i>Migrate Visa</a></li>
                        </ul>    
                    </div>
