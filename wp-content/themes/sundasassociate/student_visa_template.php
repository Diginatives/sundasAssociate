<?php //Template Name: student visa Template ?>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="visa-detail-content">
                    <div class="img-box">
                        <img src="assets/images/visa/visa-detail-1-cat-1.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <h2>Student Visa</h2>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="sidebar-style1">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">     
                            <li class="active"><a href="visa-student.html"><i class="fa fa-angle-left" aria-hidden="true"></i>Student Visa</a></li>
