<?php //Template Name: Job_seeker visa Template ?>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="visa-detail-content">
                    <div class="img-box">
                        <img src="assets/images/visa/visa-detail-1-cat-3.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <h2>Job Seeker Visa</h2>
                ...
                <div class="sidebar-style1">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">     
                            ...
                            <li class="active"><a href="visa-job.html"><i class="fa fa-angle-left" aria-hidden="true"></i>Job Seeker Visa</a></li>
