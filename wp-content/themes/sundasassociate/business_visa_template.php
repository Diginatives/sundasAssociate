<?php //Template Name: business visa Template ?>
                ...
                <div class="inner-content text-center clearfix">
                    ...
                    <div class="breadcrumb-menu wow slideInDown animated" data-wow-delay="0.3s" data-wow-duration="1500ms">
                        <ul class="clearfix">
                            ...
                            <li class="active">Visa Detail</li>
                        </ul>    
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="visa-detail-content">
                    <div class="img-box">
                        <img src="assets/images/visa/visa-detail-1-cat-2.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <h2>Business Visa Immigration</h2>
                        ...
                        <ul class="visa-detail-featured">
                            <li class="clearfix">
                                <div class="icon">
                                    <span class="flaticon-people-2 thm-clr"></span>
                                </div>
                                <div class="text">
                            ...
                            <li class="clearfix">
                                <div class="icon">
                                    <span class="flaticon-headphones-1 thm-clr"></span>
                                </div>
                                <div class="text">
                                    <h3>Great Support</h3>
                                    <p>There are many variations of passages of Lorem Ipsum available.</p>
                            ...
                            <li class="clearfix">
                                <div class="icon">
                                    <span class="flaticon-certification thm-clr"></span>
                                </div>
                                <div class="text">
                        ...
                        <div class="bottom-text">
                            <p>You use this site regularly and would like to help keep the site on the Internet, please consider donating a small sum to help pay for the hosting and bandwidth bill or randomised words which don’t look even slightly believable passage. Fusce non mi at nisl laoreet pretium Nulla ut elementum.</p>
                        </div>
                ...
                <div class="sidebar-style1">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">
                            ...
                            <li class="active"><a href="visa-business.html"><i class="fa fa-angle-left" aria-hidden="true"></i>Business Visa</a></li>
                            ...
                            <li><a href="visa-transit.html"><i class="fa fa-angle-left" aria-hidden="true"></i>Transit Visa</a></li>
